...
</td></tr><tr><td bgcolor=ffffff>网盘密码</td><td bgcolor=ffffff>
<input name="downurltext" type="text" id="downurltext" value="<?=$ecmsfirstpost==1?"":ehtmlspecialchars(stripSlashes($r[downurltext]))?>" size="60">
