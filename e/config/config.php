...
$ecms_config['db']['dbname']='zxsp';	//数据库名
...
$ecms_config['esafe']['ecookiernd']='Efhf00dtzRby6t2Sfienm3WCyhf9is';	//后台登录COOKIE认证码(填写10~50个任意字符，最好多种字符组合)
...
$ecms_config['cks']['ckvarpre']='kzaen';		//前台cookie变量前缀
$ecms_config['cks']['ckadminvarpre']='bvwrq';		//后台cookie变量前缀
$ecms_config['cks']['ckrnd']='54FbF17FZi7UtSAK4LpbwSHrQl9x60';	//COOKIE验证随机码(填写10~50个任意字符，最好多种字符组合)
$ecms_config['cks']['ckrndtwo']='WACwCInPYhBr5QYXR3jeOtr4JtIWxK';	//COOKIE验证随机码2(填写10~50个任意字符，最好多种字符组合)
